...
MCP clients (Cursor, Claude Desktop, MCP Inspector) expect OAuth with **Dynamic Client Registration** to authenticate. Some Enterprise SSO providers don't support DCR natively. This means MCP clients can't connect directly to some SSO-protected MCP servers with DCR Support.
